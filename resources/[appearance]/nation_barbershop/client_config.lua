...
local barberShops = {
    ...
    [8] = { coords = vec3(-559.12,2779.48,47.26) }, -- CONDOMINIOS
    [9] = { coords = vec3(1269.33,-247.49,104.1) }, -- BARRAGEM
    [10] = { coords = vec3(-1125.41,357.97,71.31) }, -- CASA CN
    [11] = { coords = vec3(1228.51,-1056.54,47.84) }, -- HELIPA
    [12] = { coords = vec3(-266.75,192.66,5.64) }, -- HOTEL
    [13] = { coords = vec3(-284.36,-720.97,125.46) }, -- mansão dex
    [14] = { coords = vec3(-1650.6,716.34,207.56) }, -- mansao luke
    [15] = { coords = vec3(744.7,3418.55,67.43) }, -- mansao luke
   -- [12] = { coords = vec3(-413.57,4464.85,49.25) }, -- elfos
...
local barberChairs = {
    ...
    [8] = {
        { coords = vec3(-559.12,2779.48,47.26), h = 90.71, offset = vec3(-0.04, -0.68, 0.0) },   
    },
    [9] = {
        { coords = vec3(1269.33,-247.49,104.1), h = 189.93, offset = vec3(-0.04, -0.68, 0.0) },   
    },
    [10] = {
        { coords = vec3(-1125.41,357.97,71.31), h = 331.66, offset = vec3(-0.04, -0.68, 0.0), dict = "anim@amb@clubhouse@boardroom@crew@female@var_a@base@", anim = "base" },
    },
    [11] = {
        { coords = vec3(1228.5,-1056.52,47.84), h = 303.31, offset = vec3(-0.04, -0.68, 0.0) },
    },
    [12] = {
        { coords = vec3(-266.75,192.66,5.64), h = 87.88, offset = vec3(0.02, -0.6, 0.0), dict = "anim@amb@clubhouse@boardroom@crew@female@var_a@base@", anim = "base" },
    },
    [13] = {
        { coords = vec3(-284.36,-720.97,125.46), h = 249.45, offset = vec3(-0.04, -0.68, 0.0) },  --ELFOS
    },
    [14] = {
        { coords = vec3(-1650.6,716.34,207.56), h = 0.0, offset = vec3(-0.04, -0.68, 0.0) },
    },
    [15] = {
        { coords = vec3(744.7,3418.55,67.43), h = 0.0, offset = vec3(-0.04, -0.68, 0.0) },
    },
    -- [12] = {
    --     { coords = vec3(-414.25,4465.6,49.25), h = 334.49, offset = vec3(-0.04, -0.68, 0.0) },  --ELFOS
    -- },
}
