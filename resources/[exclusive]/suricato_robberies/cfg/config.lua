...
cfg.webhook_screenshot = 'https://discord.com/api/webhooks/1009071945389703219/V1cG3qhfCoMX57rPHLvR0FnZkoXxZ-mfi0UVlRQ5Q4sBPXCYpiqcRaVM2c92sWlGtjRt' -- WEBHHOK ONDE SERÁ ENVIADO A TELA DO JOGADOR CASO ALGUM ADMINISTRADOR TIRE A PRINT ENQUANTO ESTÁ ESPECTANDO
cfg.webhook_startrob = 'https://discord.com/api/webhooks/1009071945389703219/V1cG3qhfCoMX57rPHLvR0FnZkoXxZ-mfi0UVlRQ5Q4sBPXCYpiqcRaVM2c92sWlGtjRt' -- WEBHOOK PARA NOTIFICAR QUANDO UM ROUBO INICIA (E SUAS INFORMAÇÕES)
cfg.webhook_endrob = 'https://discord.com/api/webhooks/1009071945389703219/V1cG3qhfCoMX57rPHLvR0FnZkoXxZ-mfi0UVlRQ5Q4sBPXCYpiqcRaVM2c92sWlGtjRt' -- WENHOOK PARA NOTIFICAR QUANDO UM ROUBO FINALIZA (E SEU RALATÓRIO)
cfg.webhook_killsrob = 'https://discord.com/api/webhooks/1009071945389703219/V1cG3qhfCoMX57rPHLvR0FnZkoXxZ-mfi0UVlRQ5Q4sBPXCYpiqcRaVM2c92sWlGtjRt' -- WEBHOOK PARA NOTIFICAR AS KILLS DENTRO DOS ROUBOS QUE ESTÃO OCORRENDO
cfg.webhook_cl = 'https://discord.com/api/webhooks/1009071945389703219/V1cG3qhfCoMX57rPHLvR0FnZkoXxZ-mfi0UVlRQ5Q4sBPXCYpiqcRaVM2c92sWlGtjRt' -- WEBHOOK PARA NOTIFICAR UM POSSÍVEL COMBAT-LOGGING, SÓ AVISARÁ SE ELE DESCONECTAR ENQUANTO O ROUBO NÃO ESTIVER ACABADO

cfg.OpenScoreboardKey = 'PAGEUP' -- TECLA PARA ABRIR O SCOREBOARD (ESCOLHA O INPUT PARAMETER EM: https://docs.fivem.net/docs/game-references/input-mapper-parameter-ids/keyboard/)
...
cfg.ComandoPermissao = 'Admin' -- PERMISSÃO PARA ACESSAR AS INTERFACES ADMIN DO SCRIPT

cfg.PermissaoPolicial = 'Policia' -- PERMISSÃO QUE TODO O POLICIAL APTO À ALGUMA AÇÃO TEM
...
cfg.StaffPermission = 'Admin' -- PERMISSÃO QUE SOMENTE OS STAFFS QUE PODERÃO ACEITAR ROUBOS TEM
